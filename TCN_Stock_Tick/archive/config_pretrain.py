...
# Predefined stream configurations - Stock Tick data only
STREAM_CONFIGS = {
    'stock_tick': StreamConfig(
        name='stock_tick',
        data_path=str(DATA_ROOT / 'Stock_trades_raw'),
        ...
        max_chunks_16gb=1800,   # Raw ticks: highest volume
        max_chunks_32gb=3600,   # RTX 5090
        max_chunks_80gb=10000,
        max_chunks_192gb=24000, # AMD MI300X
        prefetch_files=8,
        # Large model: raw tick data, complex patterns
        hidden_dim=512,
        num_layers=12,
        dropout=0.1,
    ),
